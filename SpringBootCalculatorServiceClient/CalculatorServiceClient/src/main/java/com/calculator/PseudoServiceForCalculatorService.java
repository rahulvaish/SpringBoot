...
public class PseudoServiceForCalculatorService {
	...
	/*
	 * public NumbersOutput callService(String firstNumber, String secondNumber,
	 * String operationPath) {
	 * 
	 * numbers.setFirstNumber(firstNumber); numbers.setSecondNumber(secondNumber);
	 * NumbersOutput output = webClientbuilder.build() .post()
	 * .uri("http://192.168.99.1:8080"+operationPath) .body(Mono.just(numbers),
	 * Numbers.class) .retrieve() .bodyToMono(NumbersOutput.class) .block();
	 * 
	 * return output; }
	 */
}